...
{
$_SESSION['authuser']=1;
header("location:include/volunteer_cpanel.php");
}
else
{
...
<title>Log In -- VISAssistant.COM</title>
<link rel="stylesheet" type="text/css" href="../style.css">
</head>

<body>

<div style=" background-color:#c5f7aa; margin-top:-10px; height:300px;">
...
<table align="center">
<tr><td>Account Type:</td><td><select name="admin_type" style="width:303px;margin-left:6px; height:30px;" >
